    ...
    <div className="flex min-h-screen items-center justify-center bg-white px-6 py-12">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="space-y-1">
          <h2 className="text-2xl font-bold text-stone-900">新規登録</h2>
        ...
        <button
          type="button"
          disabled
          className="flex h-11 w-full cursor-not-allowed items-center justify-center gap-2.5 rounded-lg border border-stone-200 bg-white text-sm font-medium text-stone-700 opacity-60"
        >
